...
const HowItWorks = () => {
  ...
  const steps = [
    {
      icon: MessageCircle,
      title: 'Client Texts Keyword',
      description: 'Customer texts "BOOK" or your custom keyword to your business number',
      color: 'from-blue-500 to-blue-600',
    },
    {
      icon: ArrowDown,
      title: 'Guided SMS Flow',
      description: 'Our AI guides them through service selection, time slots, and staff preferences',
      color: 'from-purple-500 to-purple-600',
    },
    {
      icon: CheckCircle,
      title: 'Confirmation & Payment',
      description: 'Instant booking confirmation with secure payment link sent via text',
      color: 'from-teal-500 to-teal-600',
    },
    {
      icon: RotateCcw,
      title: 'Automated Follow-ups',
      description: 'Smart reminders, feedback requests, and rebooking suggestions automatically',
      color: 'from-green-500 to-green-600',
    },
  ];

  return (
    <section id="how-it-works" ref={sectionRef} className="py-20 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Four simple steps to transform your booking process. 
            Your clients get convenience, you get more bookings.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            {steps.map((step, index) => (
              ...
              >
                <div className={`flex-shrink-0 w-14 h-14 rounded-2xl bg-gradient-to-br ${step.color} flex items-center justify-center text-white shadow-lg`}>
                ...
                <div className="p-4 space-y-4 bg-white min-h-[500px]">
                  ...
                  <div className="message text-left">
                    <div className="inline-block bg-gray-200 text-gray-900 px-4 py-2 rounded-2xl rounded-tl-md max-w-xs text-sm">
                      Hey! 👋 What service would you like to book?
        ...
        <div className="mt-20 text-center">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div>
              <div className="text-3xl font-bold text-teal-600 mb-2">30 sec</div>
