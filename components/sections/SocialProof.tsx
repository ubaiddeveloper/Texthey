  ...
  const testimonials = [
    {
      ...
      image:
        "https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop&crop=face",
      quote:
        "Text Hey changed the way we run our spa. Bookings are up 45% and our clients love the convenience. It's absolutely seamless!",
      rating: 5,
    },
    {
      ...
      quote:
        "My no-shows dropped to almost zero. Clients text to book, get reminders, and can easily reschedule. Game changer for my business.",
      rating: 5,
    },
    {
      name: "Lisa Thompson",
      ...
      image:
        "https://images.pexels.com/photos/3758105/pexels-photo-3758105.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop&crop=face",
      quote:
        "Being mobile means I need simple booking. Text Hey handles everything automatically while I focus on my clients. Perfect solution!",
      rating: 5,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join thousands of service businesses that have transformed their
            booking process and grown their revenue with Text Hey.
          </p>
        </div>
        ...
        {/* <div className="mb-16">
          ...
          <div
            ref={logoCarouselRef}
            className="flex items-center justify-center space-x-12 grayscale opacity-60"
          >
        ...
        {/* Stats */}
        <div className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-3xl p-8 lg:p-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl lg:text-4xl font-bold text-brand-cyan mb-2">
                10K+
              </div>
        ...
        <div className="mt-16 text-center">
          <blockquote className="text-2xl font-medium text-slate-900 mb-6 leading-relaxed">
            &quot;Since switching to Text Hey, our booking process is completely
            automated. We&apos;ve saved 20 hours per week and increased our
            revenue by 35%.&quot;
          </blockquote>
