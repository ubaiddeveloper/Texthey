  ...
  const stats = [
    {
      ...
      description: 'Businesses see an average 30% increase in monthly bookings within the first 60 days',
    ...
    },
    {
      ...
      description: 'Automate booking confirmations, reminders, and follow-ups to focus on what matters most',
    ...
    },
    {
      ...
      description: 'Smart reminders and easy rescheduling keep your calendar full and revenue flowing',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See the measurable impact Text Hey has on businesses just like yours. 
        ...
        <div className="mt-20 bg-white rounded-3xl shadow-xl p-8 lg:p-12 border border-gray-200">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Based on data from over 10,000 businesses, here's what you could expect 
              with Text Hey in your first year:
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="bg-gray-50 rounded-xl p-6">
                <div className="text-2xl font-bold text-teal-600 mb-2">+$18K</div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <div className="text-2xl font-bold text-teal-600 mb-2">450%</div>
                <div className="text-sm text-gray-600">Average ROI</div>
              </div>
              <div className="bg-gray-50 rounded-xl p-6">
                <div className="text-2xl font-bold text-teal-600 mb-2">3 mo</div>
